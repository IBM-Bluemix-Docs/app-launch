...
The App Launch Service currently supports Android and iOS SDKs for simplified application development. Download the SDKs and information about using them [here](install-sdk.html). Integrate the SDK into your app.
